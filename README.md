...
14. **Stickers & badges 🏅** — a Sticker Trail (one per completed week) and 12 badges, every one earned by effort and showing up (never by scores or speed); no streaks, no guilt mechanics; new-badge celebration toast
15. **Training levels 🌱🔥👑** — each quest levels Rookie → Pro → Master by parent/child confirmation ("Smashed it!"), never automatic timing-based rating; higher levels unlock tougher twists of the same game; overall Trainer Level shown on the plan
16. **Growth Report 📈** — plain-language summary of shining strengths (combining Discovery Day results with trained quest levels), courage strengths, the next growth quest, effort stats, and "movement families to explore" — deliberately never naming the sport a child "should" play
17. **Seasons & the Graduation Adventure 🎓** — Rookie Season → Pro Season → Master Season, each a fresh 12-week plan at a higher base tier (Pro twists everywhere in season 2, Master in season 3, new week themes per season). Promotion gates on effort (25/36 quests) + confidence (4 quests smashed to Pro / 6 to Master), then a Graduation Adventure: replaying the three Discovery Day activities, compared only to the child's own previous marks. Not ready = "Victory Lap", never a fail. Passing Master makes a CoachUp Champion and unlocks the champion's Growth Report with real-world sport doors (invitations, plural — never a single prediction). Badges and lifetime totals survive season resets via season history.
18. **Guide personalities 🦦🦉🐬🐨** — each guide coaches in their own voice: Remi (playful & silly), Luna (chill & wise), Dash (fast & sporty), Koko (cozy & steady). Personality shows in the picker, intro motto, weekly check-in reactions and graduation cheer.
19. **The Courage Curve 💜** — one Courage Quest per week inside the plan, forming a leadership learning curve: Weeks 1–4 *Knowing Me* (feelings, strengths, brave body language, growth mindset) → Weeks 5–8 *Standing Strong* (Safety Team, the Strong Stop, telling vs. tattling, buddy shield — the what-to-do-about-bullying toolkit) → Weeks 9–12 *Lifting Others* (upstander moves, including everyone, leading with kindness). Each quest: scenario story + "what would you do?" choices (every answer coached warmly, never shamed) + real-world mission + parent conversation prompt. All paths route back to trusted adults; week 5 carries an explicit grown-up safety note.
